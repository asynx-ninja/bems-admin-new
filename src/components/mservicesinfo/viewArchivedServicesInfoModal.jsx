...
function ViewServicesInfo({servicesinfos }) {
 

  return (
    <div>
      <div
        id="hs-modal-viewservicesinfo"
...
export default ViewServicesInfo;
