...
function RestoreLoader({ updatingStatus, error }) {
  const textPrompts = {
    updating: "Restoring official, Please wait...",
    waiting: "Please wait...",
    success: "Municipal Official Restored Successfully!",
    error: "Error restoring official. Please try again.",
  };

  const [loadingText, setLoadingText] = useState(
    textPrompts[updatingStatus] || "Restoring the official, Please wait..."
  );
