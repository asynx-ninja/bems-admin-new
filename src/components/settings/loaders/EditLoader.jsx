...
function EditLoader({ updatingStatus, error }) {
  const textPrompts = {
    updating: "Updating personal info...",
    waiting: "Please wait...",
    success: "Personal Info Updated Successful!",
    error: "Error updating info. Please try again.",
  };

  const [loadingText, setLoadingText] = useState(
    textPrompts[updatingStatus] || "Updating personal info..."
  );
  ...
  return (
    <div className="absolute top-10 lg:top-10 lg:end-0 mb-20 lg:mr-5 z-[80]">
    <div
      className="w-screen md:w-auto bg-[#268F26] border border-gray-200 rounded-xl shadow-lg"
      role="alert"
