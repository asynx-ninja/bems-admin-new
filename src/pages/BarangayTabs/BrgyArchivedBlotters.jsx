    ...
    const fetchRequests = async () => {
      try {
        const response = await axios.get(
          `${API_LINK}/requests/getdoneblotters?brgy=${brgy}&page=${currentPage}&archived=true`
        );
        ...
        <div>
          ...
          <div className="py-2 px-2 bg-gray-400 border-0 border-t-2 border-white">
            <div className="sm:flex-col-reverse lg:flex-row flex justify-between w-full">
              ...
              <div className="sm:flex-col md:flex-row flex sm:w-full lg:ml-2 xl:ml-0 lg:w-4/12">
