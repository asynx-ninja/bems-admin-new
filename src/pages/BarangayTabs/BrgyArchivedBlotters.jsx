...
import ArchiveRequestsModal from "../../components/barangaytabs/brgyblotters/ArchiveRequestsModal";
import ViewRequestModal from "../../components/barangaytabs/brgyblotters/ViewRequestModal";
import Breadcrumbs from "../../components/barangaytabs/brgyarchivedBlotters/Breadcrumbs";
import RestoreRequestsModal from "../../components/barangaytabs/brgyarchivedBlotters/RestoreRequestsModal";
  ...
  return (
    ...
    <div className="py-4 px-4">
        <div>
          ...
          <div className="sm:mt-5 md:mt-4 lg:mt-0  py-2 lg:py-4 px-5 md:px-10 lg:px-0 xl:px-10 sm:rounded-t-lg lg:rounded-t-[1.75rem]  w-full lg:w-2/5 xxl:h-[4rem] xxxl:h-[5rem] bg-[radial-gradient(ellipse_at_bottom,_var(--tw-gradient-stops))] from-[#408D51] to-[#295141]" style={{
